...
-- ===================== OBJECTIFS MENSUELS 2026 — USER 1 =====================
INSERT INTO monthly_targets (user_id, month, target, actual, year, month_num) VALUES
(1, '2026-01', 45000, 42000, 2026, 1),
(1, '2026-02', 45000, 38500, 2026, 2),
(1, '2026-03', 48000, 51200, 2026, 3),
(1, '2026-04', 48000, 47800, 2026, 4),
(1, '2026-05', 50000, 55300, 2026, 5),
(1, '2026-06', 55000, 62100, 2026, 6),
(1, '2026-07', 55000, 58900, 2026, 7),
(1, '2026-08', 52000, 49700, 2026, 8),
(1, '2026-09', 58000, 63400, 2026, 9),
(1, '2026-10', 65000, 71200, 2026, 10),
(1, '2026-11', 75000, 84500, 2026, 11),
(1, '2026-12', 85000, 92300, 2026, 12);

-- ===================== OBJECTIFS MENSUELS 2026 — USER 2 =====================
INSERT INTO monthly_targets (user_id, month, target, actual, year, month_num) VALUES
(2, '2026-01', 20000, 18000, 2026, 1),
(2, '2026-02', 22000, 21000, 2026, 2),
(2, '2026-03', 24000, 26800, 2026, 3),
(2, '2026-04', 24000, 23300, 2026, 4),
(2, '2026-05', 25000, 29700, 2026, 5),
(2, '2026-06', 26000, 24500, 2026, 6);

-- ===================== OBJECTIFS MENSUELS 2026 — USER 3 =====================
INSERT INTO monthly_targets (user_id, month, target, actual, year, month_num) VALUES
(3, '2026-01', 8000, 7500, 2026, 1),
(3, '2026-02', 9000, 8600, 2026, 2),
(3, '2026-03', 10000, 12400, 2026, 3),
(3, '2026-04', 10000, 9800, 2026, 4),
(3, '2026-05', 11000, 13600, 2026, 5),
(3, '2026-06', 12000, 11800, 2026, 6);

-- ===================== VENTES — USER 1 (2026) =====================
INSERT INTO sales (user_id, product_id, date, quantity, unit_price, customer_name, payment_method) VALUES
(1, 1, '2026-01-05', 2, 1299.00, 'Karim Khali', 'carte'),
(1, 4, '2026-01-08', 5, 279.00, 'Sophie Martin', 'espèces'),
(1, 5, '2026-01-12', 8, 79.00, 'Pierre Moreau', 'carte'),
(1, 8, '2026-01-15', 30, 18.00, 'Jean Lefebvre', 'virement'),
(1, 2, '2026-01-20', 3, 999.00, 'Marie Lambert', 'carte'),
(1, 12, '2026-01-25', 12, 35.00, 'Léa Rousseau', 'carte'),
(1, 9, '2026-01-28', 50, 12.00, 'Nathalie Bernard', 'virement'),
(1, 3, '2026-02-03', 2, 1599.00, 'Fatima Alaoui', 'carte'),
(1, 6, '2026-02-07', 15, 59.00, 'Thomas Petit', 'espèces'),
(1, 7, '2026-02-12', 7, 129.00, 'Ahmed Benali', 'carte'),
(1, 8, '2026-02-15', 25, 18.00, 'Karim Khali', 'carte'),
(1, 4, '2026-02-20', 8, 279.00, 'Pierre Moreau', 'carte'),
(1, 1, '2026-02-28', 4, 1299.00, 'Sophie Martin', 'carte'),
(1, 1, '2026-03-05', 8, 1299.00, 'Jean-Paul Lebrun', 'carte'),
(1, 3, '2026-03-10', 5, 1599.00, 'Nathalie Bernard', 'carte'),
(1, 6, '2026-03-15', 20, 59.00, 'Fatima Alaoui', 'espèces'),
(1, 10, '2026-03-18', 3, 899.00, 'Karim Khali', 'virement'),
(1, 11, '2026-03-22', 25, 49.00, 'Léa Rousseau', 'carte'),
(1, 2, '2026-03-28', 6, 999.00, 'Marie Lambert', 'carte'),
(1, 12, '2026-03-30', 22, 35.00, 'Thomas Petit', 'carte'),
(1, 4, '2026-04-05', 12, 279.00, 'Ahmed Benali', 'carte'),
(1, 8, '2026-04-10', 40, 18.00, 'Jean Lefebvre', 'espèces'),
...
-- ===================== VENTES — USER 2 (2026) =====================
INSERT INTO sales (user_id, product_id, date, quantity, unit_price, customer_name, payment_method) VALUES
(2, 13, '2026-01-10', 5, 45.00, 'Omar Hadj', 'carte'),
(2, 14, '2026-01-15', 2, 250.00, 'Yasmine B.', 'espèces'),
(2, 15, '2026-02-05', 1, 320.00, 'Rachid K.', 'virement'),
(2, 13, '2026-02-12', 8, 45.00, 'Amine S.', 'carte'),
(2, 14, '2026-03-03', 3, 250.00, 'Lina T.', 'carte'),
(2, 15, '2026-03-20', 2, 320.00, 'Omar Hadj', 'carte');

-- ===================== VENTES — USER 3 (2026) =====================
INSERT INTO sales (user_id, product_id, date, quantity, unit_price, customer_name, payment_method) VALUES
(3, 16, '2026-01-08', 10, 15.00, 'Claire D.', 'carte'),
(3, 17, '2026-01-20', 6, 22.00, 'Marc F.', 'espèces'),
(3, 18, '2026-02-14', 4, 35.00, 'Julie P.', 'carte'),
(3, 16, '2026-02-25', 15, 15.00, 'Anna R.', 'carte'),
(3, 17, '2026-03-10', 8, 22.00, 'Claire D.', 'virement'),
(3, 18, '2026-03-28', 6, 35.00, 'Marc F.', 'carte');

-- ===================== AVIS CLIENTS — USER 1 =====================
INSERT INTO reviews (user_id, product_id, customer_name, rating, comment, sentiment, score, date) VALUES
(1, 1, 'Sophie Martin', 5, 'Excellent produit, livraison rapide et emballage parfait. Je recommande vivement !', 'positif', 0.95, '2026-03-15'),
(1, 5, 'Ahmed Benali', 2, 'Très déçu de la qualité, la couture s''est défaite après seulement 2 semaines d''utilisation.', 'négatif', 0.12, '2026-03-14'),
(1, 3, 'Marie Dupont', 5, 'Performance incroyable, batterie longue durée. Le meilleur ordinateur que j''aie jamais eu !', 'positif', 0.97, '2026-03-13'),
(1, 8, 'Jean-Paul Lebrun', 3, 'Café correct mais pas exceptionnel pour le prix. La livraison était dans les temps.', 'neutre', 0.52, '2026-03-12'),
(1, 6, 'Fatima Alaoui', 5, 'Magnifique robe, très belle coupe et tissu de qualité. J''en suis très satisfaite !', 'positif', 0.93, '2026-03-11'),
(1, 7, 'Pierre Moreau', 1, 'Totalement insatisfait. Produit non conforme à la description, taille incorrecte et service client inexistant.', 'négatif', 0.03, '2026-03-10'),
(1, 4, 'Léa Rousseau', 4, 'Très bon son et réduction de bruit efficace. Légers et confortables pour une utilisation prolongée.', 'positif', 0.82, '2026-03-09'),
(1, 12, 'Karim Khali', 5, 'Parfait pour mes séances de yoga quotidiennes, antidérapant et facile à nettoyer.', 'positif', 0.91, '2026-03-08'),
(1, 10, 'Nathalie Bernard', 3, 'Design sympa mais montage difficile. Instructions peu claires. Résultat final acceptable.', 'neutre', 0.48, '2026-03-07'),
(1, 2, 'Thomas Petit', 4, 'Très bon smartphone, caméra excellente. Juste un peu cher mais qualité au rendez-vous.', 'positif', 0.78, '2026-03-06');

-- ===================== AVIS CLIENTS — USER 2 =====================
INSERT INTO reviews (user_id, product_id, customer_name, rating, comment, sentiment, score, date) VALUES
(2, 14, 'Yasmine B.', 5, 'Parfum magnifique, tenue longue durée. Je recommande !', 'positif', 0.9, '2026-03-15'),
(2, 15, 'Rachid K.', 3, 'Bon cuir mais finition moyenne. Rapport qualité-prix correct.', 'neutre', 0.5, '2026-03-18'),
(2, 13, 'Amine S.', 4, 'Très bonne chemise, confortable et belle coupe.', 'positif', 0.75, '2026-03-20');

-- ===================== AVIS CLIENTS — USER 3 =====================
INSERT INTO reviews (user_id, product_id, customer_name, rating, comment, sentiment, score, date) VALUES
(3, 16, 'Anna R.', 5, 'Thé délicieux, arôme subtil. Emballage soigné.', 'positif', 0.88, '2026-03-14'),
(3, 17, 'Marc F.', 4, 'Bonne bougie, odeur agréable mais tenue moyenne.', 'positif', 0.72, '2026-03-16');
...
(1, 6, '2027-01', 78500, 0.85, 'LinearRegression'),
(1, 6, '2027-02', 82000, 0.83, 'LinearRegression'),
(1, 6, '2027-03', 94500, 0.81, 'LinearRegression'),
(1, 6, '2027-04', 88200, 0.79, 'LinearRegression'),
(1, 6, '2027-05', 97800, 0.77, 'LinearRegression'),
(1, 6, '2027-06', 105400, 0.74, 'LinearRegression');
