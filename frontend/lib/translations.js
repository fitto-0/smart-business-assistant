const translations = {
  en: {
    ...
    products: {
      ...
      promotionPricePlaceholder: "Leave empty for no promotion",
      stock: "Stock",
      sold: "Sold",
      revenue: "Revenue",
      status: "Status",
    ...
    sales: {
      ...
      recentSalesTitle: "Last sold products and orders",
  ...
  fr: {
    ...
    sales: {
      ...
      recentSalesTitle: "Derniers produits vendus et commandes",
  ...
  ar: {
    ...
    sales: {
      ...
      recentSalesTitle: "آخر المنتجات المباعة والطلبات",
      noRecentSales: "لا توجد مبيعات مسجلة بعد",
      product: "المنتج",
      customer: "العميل",
      total: "الإجمالي",
