...
export default function StorefrontAboutPage() {
  ...
  const primaryColor = storeSettings?.primary_color || "#1e293b63";
  ...
  const values = [
    ...
    },
    {
      ...
      title: "Trusted Brand",
      description:
        "Thousands of happy customers trust us for their shopping needs.",
    },
    {
      icon: Users,
      title: "Community Focus",
      description:
        "We believe in giving back and supporting local communities.",
    },
  ];
  ...
  const team = [
    {
      name: "Alex Johnson",
      role: "Founder & CEO",
      bio: "Visionary leader with 15+ years in retail.",
    },
    {
      name: "Sarah Chen",
      role: "Head of Products",
      bio: "Curates the finest selection for our store.",
    },
    {
      name: "Mike Rodriguez",
      role: "Customer Success",
      bio: "Ensures every customer has a great experience.",
    },
    {
      name: "Emily Davis",
        ...
        >
          ...
          >
            {storeSettings?.description ||
              "We are passionate about bringing you the best products at the best prices. Our journey started with a simple idea: make quality shopping accessible to everyone."}
          </p>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg mb-4" style={{ color: textSecondaryColor }}>
                ...
                while making a positive impact in our community and the world.
              </p>
              <p className="mb-4" style={{ color: textSecondaryColor }}>
                We believe that shopping should be an enjoyable experience, not
                a chore. That's why we carefully curate every product in our
                store, ensuring it meets our high standards for quality, value,
                and style.
              </p>
              <p style={{ color: textSecondaryColor }}>
                Our commitment to excellence drives everything we do - from the
                products we select to the way we treat our customers.
              </p>
            </div>
      ...
      <section className="py-16" style={{ backgroundColor: secondaryColor }}>
        ...
        >
          ...
          <p className="text-white/80 mb-8 max-w-2xl mx-auto">
            ...
            preferred choice for quality products.
          </p>
          <a
