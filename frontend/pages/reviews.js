  ...
  <div className="flex gap-0.5">
    {[1, 2, 3, 4, 5].map((i) => (
      <Star
        key={i}
        size={12}
        className={i <= n ? "text-amber-400 fill-amber-400" : "text-slate-600"}
      />
    ))}
  </div>
);
    ...
    <Layout title="Analyse des Avis Clients">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 mb-6">
        ...
        <div className="card flex flex-col items-center">
          <h3 className="text-base font-bold text-white mb-1 self-start">
              ...
              return (
                <div key={star} className="flex items-center gap-3">
                  ...
                  <div className="flex-1 bg-dark-900 rounded-full h-2.5">
                    <div
                      className="h-2.5 rounded-full bg-gradient-to-r from-amber-500 to-amber-400 transition-all"
                      style={{ width: `${pct}%` }}
                    />
                  </div>
      ...
      <div className="card">
        ...
        <div className="space-y-4">
          {reviews.map((review) => (
            <div
              key={review.id}
              className="p-4 rounded-xl bg-dark-900/50 border border-slate-700/40 hover:border-slate-600/60 transition-all"
            >
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="w-40">
                  <p className="text-xs text-slate-500 mb-1">
                    Score IA : {Math.round(Number(review.score || 0) * 100)}%
                  </p>
