      ...
      <main className="not-found-page">
        <div className="not-found-frame">
          <header className="not-found-header">
            <button className="not-found-menu" type="button" aria-label="Open menu">
              <Menu size={12} />
              <span>Menu</span>
            </button>
            <Link href="/" className="not-found-brand">Smart Business<span>.</span></Link>
          </header>
          ...
          <section className="not-found-content" aria-labelledby="not-found-title">
            ...
            <div className="not-found-copy">
              ...
              <p>We searched everywhere, but this address is not connected to the dashboard.</p>
